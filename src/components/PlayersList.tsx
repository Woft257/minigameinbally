  ...
  return (
    <div className="space-y-4 p-4 sm:p-6">
      <div className="flex items-center space-x-3">
        ...
        <h2 className="text-xl sm:text-2xl font-bold text-white">Players</h2>
        ...
        {Object.entries(countryGroups).map(([country, countryPlayers]) => (
          ...
          >
            <div className="flex items-center space-x-2 mb-3">
              ...
              <h3 className="font-base sm:font-semibold text-white">{country}</h3>
              ...
              {countryPlayers.map((player) => (
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm sm:text-base text-gray-200">{player.name}</span>
                  </div>
